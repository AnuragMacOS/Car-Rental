...
class car{
    string car_mark [10] = {"Hyundai", "BMW", "Mercedes", "Audi",
                            "Tesla", "Skoda", "Kia", "Toyota", "Ford"};
    string model [10]  = {"2019MD","22AS","2021DS","2018LA","209MW",
                         "2015Ps","2018PW","2017QW","2022SA"};
    string color [10]  ={"Red","black","yellow","Blue","Red","Brown",
                         "Silver","Black","grey"};
    string maxs_peed [10] ={"190 Km/h ","180 Km/h","220 Km/h","200 Km/h"
                ,"230 Km/h","160 Km/h","180 Km/h","140 Km/h","200 Km/h"};
